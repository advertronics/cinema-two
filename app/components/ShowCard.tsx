...
export type TShow = {
  ...
  //productionTeam: PTprops[]
}

const ShowCard = ({ show }: { show: TShow }) => {
  const { title, quality, restriction, category, release, thumbnail, id, urlTitle } = show
  return (
    <div className="show-slider-card">
      <a href={`category/${category.replace(" ", "-").toLowerCase()}/${urlTitle}`}>
